    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9 col-md-push-3">
                <div class="result-sorting-wrapper">
                    <div class="sorting-count">
                        ...
                        if(isset($_POST['searchval']))
                        {
                            ...
                            $sql = "SELECT id from tblvehicles where tblvehicles.VehiclesTitle=:search";
                            $query = $dbh->prepare($sql);
                            $query->bindParam(':search',$searchval, PDO::PARAM_STR);
                        }
                        else
                        {
                ...
                {
                    $searchval = $_POST['searchval'];
                    $sql = "SELECT tblvehicles.*,tblbrands.BrandName,tblbrands.id as bid  from tblvehicles join tblbrands on tblbrands.id=tblvehicles.VehiclesBrand where tblvehicles.VehiclesTitle=:search";
                    $query = $dbh->prepare($sql);
                    $query->bindParam(':search',$searchval, PDO::PARAM_STR);
                }
                else
